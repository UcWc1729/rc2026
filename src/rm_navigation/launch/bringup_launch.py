...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value= os.path.join(bringup_dir,'map', 'map_01.yaml'),
    ...
    # livox_frame -> base_link 静态变换（与 sentry.urdf base_joint 一致）
    # robot_state_publisher 未起时补齐，使 odom -> base_link 链可达
    static_tf_livox_base = Node(
        package='tf2_ros',
